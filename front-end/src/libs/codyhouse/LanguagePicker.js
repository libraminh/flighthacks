...
function initButtonPicker(picker) { // create the button element -> picker trigger
  ...
  button = button + '<span aria-hidden="true" class="language-picker__label language-picker__flag language-picker__flag--'+picker.select.querySelector('option[selected]').lang+'">' + '<img src="' + picker.select.querySelector('option[selected]').dataset.flagImage + '" alt="' + picker.select.querySelector('option[selected]').lang + '" class="icon">'+'<em>'+picker.selectedOption+'</em>';
